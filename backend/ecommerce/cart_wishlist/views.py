...
class WishlistItemViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        # Prevent duplicate wishlist entries (same product + variant)
    ...
    def remove_from_wishlist(self, request, product_id=None):
        """
        Remove a wishlist item by product_id.
        Optionally pass variant_id in request body to remove a specific variant.
        """
        try:
...
class CartItemViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        # If same product + variant already exists in cart, increment quantity
    ...
    def remove_from_cart(self, request, product_id=None):
        """
        Remove a cart item by product_id.
        Optionally pass variant_id in request body to remove a specific variant.
        """
        try:
